						...
						<div class="tab-pane active" id="add-coach">
							<div class="timeline">
								<div class="tab-content-heading">
									<h4>Thêm lộ trình dự định mới</h4>
									<a href="user/dashboard"><i class="fas fa-angle-double-left"></i>Back</a>
								</div>
								<div class="edit-profile">
									<form action="user/schedule/create" method="POST" enctype="multipart/form-data">
										@csrf
										...
										<div class="form-group">
											...
											<div class="field-input">
												<input type="text" class="video-form" id="locationUser" name="pick_up_location" required="">			
											</div>											
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="field-input">
												<input type="text" class="video-form" id="locationUser" name="drop_off_location" required="">		
											</div>											
										</div>
										<div class="form-group">
											<label for="emailAddress">Số người dự kiến</label>
											<input type="number" class="video-form" id="emailAddress" name="number_passenger" required="">							
										</div>
										<div class="form-group">
											<label for="locationUser">Ngày dự kiến</label>
											<div class="field-input">
												<input type="date" class="video-form my-1" id="date" name="date" >
											</div>											
										</div>
										<div class="form-group">
											<label for="locationUser">Thời gian dự kiến</label>
											<div class="field-input">
												<input type="time" class="video-form my-1" id="time" name="time" >
											</div>											
										</div>
