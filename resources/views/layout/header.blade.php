						...
						<div class="menu-items">
							<nav class="navbar navbar-expand-lg navbar-light bg-light menu-right">										
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent">
									<ul class="navbar-nav mr-auto nav-text">
										...
										<li class="nav-item">
											<a class="nav-link" href="partners.html">Tìm xe khách</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="how_to_orders.html">Xe chiều về<img src="images/hot.gif" alt=""></a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="partners.html">Đi chung</a>
										</li>
										<li class="nav-item dropdown">
											<a class="nav-link dropdown-toggle-no-caret" href="#" id="megaDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Khác <i class="fas fa-caret-down"></i></a>																										
							...
							<div class="icons-set">
								<ul class="list-inline">
									...
									<li class="nav-item dropdown">
									<a  class="dropdown-toggle-no-caret" href="#" id="accountDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user-circle"></i> Huy Quang  <i class="fas fa-caret-down"></i></a>
